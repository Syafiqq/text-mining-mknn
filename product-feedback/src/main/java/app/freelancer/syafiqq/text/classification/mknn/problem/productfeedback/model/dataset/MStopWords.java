 ...
 * Name         : syafiq
 * Date / Time  : 23 April 2017, 10:10 AM.
 * Email        : syafiq.rezpector@gmail.com
 * Github       : syafiqq
 */
@SuppressWarnings("WeakerAccess") public class MStopWords
{
    ...
    public MStopWords(int id, String word, @NotNull MLocale locale)
    {
        this.id = id;
        this.word = word;
        this.locale = locale;
    ...
    public MStopWords(String word, @NotNull MLocale locale)
    {
    ...
    @Override public boolean equals(Object o)
    {
        ...
        if(!(o instanceof MStopWords))
        {
            return false;
        }

        MStopWords mQuery = (MStopWords) o;
